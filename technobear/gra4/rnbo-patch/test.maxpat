...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.5, 234.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 52.0, 183.0, 22.0 ],
					"text" : "read ~/Music/samples/long1.wav"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 327.0, 127.0, 66.0, 22.0 ],
					"text" : "buffer~ buf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 279.0, 190.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 250.0, 142.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.5, 234.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 165.5, 477.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 653.0, 86.0, 20.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 579.0, 79.0, 20.0, 23.0 ],
									"rnbo_classname" : "message",
									"rnbo_extra_attributes" : 									{
										"text" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 579.0, 137.0, 30.0, 23.0 ],
									"rnbo_classname" : "sig~",
									"rnbo_extra_attributes" : 									{
										"unit" : "ms"
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 365.75, 95.0, 149.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 284.0, 179.0, 51.0, 23.0 ],
									"rnbo_classname" : "*",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 63.75, 192.0, 29.5, 23.0 ],
									"rnbo_classname" : "+~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 150.0, 106.0, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 537.5, 416.0, 130.0, 130.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 121.0, 541.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 455.5, 250.5, 71.5, 50.0 ],
									"text" : "buffer channel offset"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 443.5, 225.5, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 374.5, 258.0, 58.0, 35.0 ],
									"text" : "playback rate"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 349.5, 233.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 278.5, 250.5, 58.0, 50.0 ],
									"text" : "grain length (samples)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.899999999999977, 114.0, 81.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 171.333333333333314, 258.0, 71.166666666666686, 35.0 ],
									"text" : "start time (samples)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 161.5, 233.0, 81.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 34.5, 52.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 34.5, 147.0, 42.0, 23.0 ],
									"rnbo_classname" : ">~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 34.5, 95.0, 61.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 67.5, 301.0, 159.0, 23.0 ],
...
,
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "granulator~_obj-21",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"trigger" : 											{
...
, 											{
										...
										"operator" : 0,
										"versionId" : 1036217490,
										"changesPatcherIO" : 0
									}
,
									"text" : "granulator~ buf @channels 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 67.5, 541.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
					"patching_rect" : [ 172.0, 198.0, 40.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "523cdec7-717a-11ed-9ec7-6e9de1f20473"
					}
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"__presetid" : "523cdec7-717a-11ed-9ec7-6e9de1f20473"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "523cdec7-717a-11ed-9ec7-6e9de1f20473",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20221201.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "d8452bcf0c930839d21ee94d9453572b"
									}
...
,
		"dependency_cache" : [ 			{
				"name" : "untitled_20221201.maxsnap",
