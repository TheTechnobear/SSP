...
void PageMiniView::chgParamPage(int inc, bool changeVis) {
...
void PageMiniView::eventUp(bool v) {
    base_type::eventUp(v);
...
void PageMiniView::eventDown(bool v) {
...
void PageMiniView::onEncoder(unsigned enc, float v) {
...
void PageMiniView::onEncoderSwitch(unsigned enc, bool v) {
...
void PageMiniView::onButton(unsigned int bidx, bool v) {
...
void PageMiniView::eventButton(unsigned int bidx, bool longPress) {
